...
enum PlayerActionTypes
{
	...
	PLAYER_ACTION_ASYNC_RANDOM,
	PLAYER_ACTION_UPDATE_NATIVE_BARGAIN_EFFECT,
...
enum DiploEventTypes
{
	...
	DIPLOEVENT_ACQUIRE_USED_SHIPS_COUNTER_RESET,
	DIPLOEVENT_ACQUIRE_FOREIGN_IMMIGRANTS_COUNTER_RESET,
...
enum UnitAIStates
{
	...
	UNITAI_STATE_TRANSPORT_SETTLER,
	NUM_UNITAI_STATES,
};
