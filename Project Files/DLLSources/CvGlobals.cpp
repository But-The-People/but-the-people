...
m_LBD_CHANCE_INCREASE_EXPERT_FROM_TEACHER(0), // WTP, ray, teacher addon for LbD
m_LBD_PRE_ROUNDS_EXPERT_DECREASE_FROM_TEACHER(0), // WTP, ray, teacher addon for LbD
...
m_pAutogeneratedCivEffect(NULL),
// Native Raids
...
const CivEffectInfo& CvGlobals::getCivEffectInfo(CivEffectTypes eCivEffect) const
{
	...
	FAssert(eCivEffect < NUM_CIV_EFFECT_TYPES);
...
void CvGlobals::cacheGlobals()
{
	...
	m_LBD_CHANCE_INCREASE_EXPERT_FROM_TEACHER = getDefineINT("LBD_CHANCE_INCREASE_EXPERT_FROM_TEACHER"); // WTP, ray, teacher addon for LbD
	m_LBD_PRE_ROUNDS_EXPERT_DECREASE_FROM_TEACHER = getDefineINT("LBD_PRE_ROUNDS_EXPERT_DECREASE_FROM_TEACHER"); // WTP, ray, teacher addon for LbD
