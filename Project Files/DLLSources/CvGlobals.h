...
class CvTradeLocationInfo; // trade screen type - Nightinggale
...
public:
	...
	int getNumTradeLocationInfos() const;
	std::vector<CvTradeLocationInfo*>& getTradeLocationInfo();
	const CvTradeLocationInfo& getTradeLocationInfo(TradeLocationTypes eTradeLocation) const;
...
protected:
	...
	************************************************************************************************************************/
	...
	//Androrc End
	std::vector< CvTradeLocationInfo*> m_paTradeScreenInfo; // trade screen type - Nightinggale
